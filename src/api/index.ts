...
export const reportsApi = {
  ...
  propertyDamage:   (params?: Record<string, unknown>) => api.get('/reports/property-damage', { params, responseType: 'blob' }),
  risks:            (params?: Record<string, unknown>) => api.get('/reports/risks', { params, responseType: 'blob' }),
